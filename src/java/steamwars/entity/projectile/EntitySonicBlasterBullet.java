...
public class EntitySonicBlasterBullet extends EntityThrowable
	{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntitySonicBlasterBullet(World par1World)
		{
		super(par1World);
		}
	
	public EntitySonicBlasterBullet(World par1World, EntityLivingBase entitylivingbase)
		{
	...
	public EntitySonicBlasterBullet(World par1World, double par2, double par4, double par6)
		{
	...
	protected void onImpact(MovingObjectPosition movingobjectposition)
		...
		if (movingobjectposition != null && movingobjectposition.entityHit != null)
			...
			if (movingobjectposition.entityHit.isEntityAlive())
				{
				movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this), ((int) (this.damage * 2)));
				movingobjectposition.entityHit.addVelocity(this.motionX*2.5, this.motionY*2.5, this.motionZ*2.5);
				}
			}

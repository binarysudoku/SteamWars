...
public class EntityArcPistolBullet extends EntityThrowable
	{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityArcPistolBullet(World par1World)
		{
		super(par1World);
		}
	
	public EntityArcPistolBullet(World par1World, EntityLivingBase entitylivingbase)
		{
	...
	public EntityArcPistolBullet(World par1World, double par2, double par4, double par6)
		{

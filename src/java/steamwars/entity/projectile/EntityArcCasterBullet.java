...
public class EntityArcCasterBullet extends EntityThrowable
	{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityArcCasterBullet(World par1World)
		{
		super(par1World);
		}
	
	public EntityArcCasterBullet(World par1World, EntityLivingBase entitylivingbase)
		{
	...
	public EntityArcCasterBullet(World par1World, double par2, double par4, double par6)
		{

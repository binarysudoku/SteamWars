...
public class EntityPulseBlasterBullet extends EntityThrowable
	{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityPulseBlasterBullet(World par1World)
		{
		super(par1World);
		}
	
	public EntityPulseBlasterBullet(World par1World, EntityLivingBase entitylivingbase)
		{
	...
	public EntityPulseBlasterBullet(World par1World, double par2, double par4, double par6)
		{

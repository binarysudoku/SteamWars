...
public class EntitySonicPistolBullet extends EntityThrowable
	{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntitySonicPistolBullet(World par1World)
		{
		super(par1World);
		}
	
	public EntitySonicPistolBullet(World par1World, EntityLivingBase entitylivingbase)
		{
	...
	public EntitySonicPistolBullet(World par1World, double par2, double par4, double par6)
		{
	...
	protected void onImpact(MovingObjectPosition movingobjectposition)
		...
		if (movingobjectposition != null && movingobjectposition.entityHit != null)
			...
			if (movingobjectposition.entityHit.isEntityAlive())
				...
				movingobjectposition.entityHit.addVelocity(this.motionX, this.motionY, this.motionZ);
				}
			}

...
public class EntityPsiGunBullet extends EntityThrowable
	{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityPsiGunBullet(World par1World)
		{
		super(par1World);
		}
	
	public EntityPsiGunBullet(World par1World, EntityLivingBase entitylivingbase)
		{
	...
	public EntityPsiGunBullet(World par1World, double par2, double par4, double par6)
		{

...
public class GhostGoggles extends ItemArmor
	{
	//private String texturePath = ModInfo.ID + ":/textures/models/armor/ghostGear_layer_1.png";
	
	public GhostGoggles(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String name)
		{

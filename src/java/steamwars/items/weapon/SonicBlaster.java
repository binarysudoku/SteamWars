...
public class SonicBlaster extends Item
	...
	public SonicBlaster(int id)
		...
		setUnlocalizedName("sonicBlaster");
		}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
		...
		if (f > 0.5F)
			{
			if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.sonicBlasterBullet.itemID))
				{
				...
				if (!par2World.isRemote)
					{
					EntitySonicBlasterBullet entitybullet = new EntitySonicBlasterBullet(par2World, par3EntityPlayer);
					entitybullet.setDamage(f);
					par2World.spawnEntityInWorld(entitybullet);
					par3EntityPlayer.inventory.consumeInventoryItem(Items.sonicBlasterBullet.itemID);
					}
				}
			else
				{

...
public class SonicPistol extends Item
	{
	
	public SonicPistol(int id)
		{
		super(id);
		this.maxStackSize = 1;
		this.setMaxDamage(384);
		this.setCreativeTab(SteamWars.tabSteamwars);
		setUnlocalizedName("sonicPistol");
		}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
		...
		if (f > 0.2F)
			{
			if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.sonicPistolBullet.itemID))
				{
				...
				if (!par2World.isRemote)
					{
					EntitySonicPistolBullet entitybullet = new EntitySonicPistolBullet(par2World, par3EntityPlayer);
					entitybullet.setDamage(f);
					par2World.spawnEntityInWorld(entitybullet);
					par3EntityPlayer.inventory.consumeInventoryItem(Items.sonicPistolBullet.itemID);
					}
				}
			else
				{

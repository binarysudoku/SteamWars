...
public class PlasmaPistol extends Item
	...
	public PlasmaPistol(int id)
		{
		super(id);
		this.maxStackSize = 1;
		this.setMaxDamage(384);
		this.setCreativeTab(SteamWars.tabSteamwars);
		setUnlocalizedName("plasmaPistol");
		}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
		...
		if (f > 0.8F)
			{
			if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.plasmaPistolBullet.itemID))
				{
				...
				if (!par2World.isRemote)
					{
					EntityPlasmaPistolBullet entitybullet = new EntityPlasmaPistolBullet(par2World, par3EntityPlayer);
					entitybullet.setDamage(f);
					par2World.spawnEntityInWorld(entitybullet);
					par3EntityPlayer.inventory.consumeInventoryItem(Items.plasmaPistolBullet.itemID);
					}
				}
			else
				{

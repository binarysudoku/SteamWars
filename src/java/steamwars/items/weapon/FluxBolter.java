...
public class FluxBolter extends Item
	{
	
	public FluxBolter(int id)
		{
		super(id);
		this.maxStackSize = 1;
		this.setMaxDamage(384);
		this.setCreativeTab(SteamWars.tabSteamwars);
		setUnlocalizedName("fluxBolter");
		}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
		...
		if (f > 0.2F)
			{
			if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.fluxBolterBullet.itemID))
				{
				...
				if (!par2World.isRemote)
					{
					EntityFluxBolterBullet entitybullet = new EntityFluxBolterBullet(par2World, par3EntityPlayer);
					entitybullet.setDamage(f);
					par2World.spawnEntityInWorld(entitybullet);
					par3EntityPlayer.inventory.consumeInventoryItem(Items.fluxBolterBullet.itemID);
					}
				}
			else
				{

...
public class PulseRifle extends Item
	...
	public PulseRifle(int id)
		{
		super(id);
		this.maxStackSize = 1;
		this.setMaxDamage(384);
		this.setCreativeTab(SteamWars.tabSteamwars);
		setUnlocalizedName("pulseRifle");
		}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
		...
		if (f > 0.2F)
			{
			if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.pulseRifleBullet.itemID))
				{
				...
				if (!par2World.isRemote)
					{
					EntityPulseRifleBullet entitybullet = new EntityPulseRifleBullet(par2World, par3EntityPlayer);
					entitybullet.setDamage(f);
					par2World.spawnEntityInWorld(entitybullet);
					par3EntityPlayer.inventory.consumeInventoryItem(Items.pulseRifleBullet.itemID);
					}
				}
			else
				{

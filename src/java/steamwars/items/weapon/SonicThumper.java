...
public class SonicThumper extends Item
	{
	
	public SonicThumper(int id)
		{
		super(id);
		this.maxStackSize = 1;
		this.setMaxDamage(384);
		this.setCreativeTab(SteamWars.tabSteamwars);
		setUnlocalizedName("sonicThumper");
		}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
		...
		if (f > 0.5F)
			{
			if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.sonicThumperBullet.itemID))
				{
				...
				if (!par2World.isRemote)
					{
					EntitySonicThumperBullet entitybullet = new EntitySonicThumperBullet(par2World, par3EntityPlayer);
					entitybullet.setDamage(f);
					par2World.spawnEntityInWorld(entitybullet);
					par3EntityPlayer.inventory.consumeInventoryItem(Items.sonicThumperBullet.itemID);
					}
				}
			else
				{
